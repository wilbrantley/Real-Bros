/*   STEP 1   */
export const leagueID = "820148993144225792"; // your league ID
export const leagueName = "Real Bros of Dub Valley"; // your league name
...
//       "bio": "Lorem ipsum...",
      "photo": "/managers/Wil.jpg", // square ratio recommended (no larger than 500x500)
      "fantasyStart": 2013, // (optional) when did the manager start playing fantasy football
      "favoriteTeam": "atl", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
      "mode": "Rebuild", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
        name: "Falk", // Can be anything (usually your rival's name)
...
//       "bio": "Lorem ipsum...",
      "photo": "/managers/Hobie.jpg", // square ratio recommended (no larger than 500x500)
